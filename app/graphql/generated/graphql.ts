...
export type ChangeNotificationSettingsMutation = { changeNotificationSettings: { notificationSettings: { siteNotifications: boolean } } };

export type CreateStreamStartMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateStreamStartMutation = { createStreamStart: { payload: unknown, isRead: boolean } };

export type CreateVerifyChannelMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateVerifyChannelMutation = { createVerifyChannel: { payload: unknown, isRead: boolean } };
...
export type FindMyFollowersQuery = { findMyFollowers: Array<{ follower: { id: string, username: string, email: string, avatar: string | null } }> };
...
export const ChangeNotificationSettingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ChangeNotificationSettings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"isEnable"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"changeNotificationSettings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"isEnable"},"value":{"kind":"Variable","name":{"kind":"Name","value":"isEnable"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"notificationSettings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"siteNotifications"}}]}}]}}]}}]} as unknown as DocumentNode<ChangeNotificationSettingsMutation, ChangeNotificationSettingsMutationVariables>;
export const CreateStreamStartDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateStreamStart"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createStreamStart"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"isRead"}}]}}]}}]} as unknown as DocumentNode<CreateStreamStartMutation, CreateStreamStartMutationVariables>;
export const CreateVerifyChannelDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CreateVerifyChannel"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createVerifyChannel"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"payload"}},{"kind":"Field","name":{"kind":"Name","value":"isRead"}}]}}]}}]} as unknown as DocumentNode<CreateVerifyChannelMutation, CreateVerifyChannelMutationVariables>;
