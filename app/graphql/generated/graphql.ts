...
export type FindMyFollowingsQuery = { findMyFollowings: Array<{ following: { id: string, username: string, avatar: string | null, isVerified: boolean, stream: { isLive: boolean } | null } }> };
